...
const canadianHubs = [
  {
    ...
    headline: "In-Home & Virtual Physiotherapy across the GTA",
    hubs: ["Downtown / Financial District", "North York & Yorkville", "Etobicoke", "Scarborough", "Mississauga"],
  ...
  },
  {
    ...
    headline: "Restoring Movement across Lower Mainland & Coast",
    hubs: ["Kitsilano & West Point Grey", "Yaletown", "North Vancouver", "Richmond", "Burnaby"],
    image: "https://images.unsplash.com/photo-1559511260-66a65e09b2ee?auto=format&fit=crop&q=80&w=800",
  },
  {
    id: "loc-calgary",
    ...
    headline: "Spine & Sports Rehabilitation in Alberta",
    hubs: ["Downtown Calgary / Beltline", "Kensington", "South Calgary", "Airdrie"],
  ...
  },
  {
    ...
    provinceCode: "ON",
    slug: "ontario/ottawa",
    headline: "Bilingual Physiotherapy in the National Capital",
    hubs: ["Centretown & Glebe", "Kanata Tech Hub", "Nepean", "Orleans"],
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 space-y-12">
        <div className="max-w-4xl mx-auto text-center space-y-6 flex flex-col items-center animate-reveal-up">
          <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-primary/10 border border-primary/20 text-primary text-xs font-bold uppercase tracking-[0.2em] shadow-sm">
            <Globe className="w-4 h-4" /> Nationwide Canadian Network
          </div>
          ...
          <p className="text-base md:text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto font-light">
            Standardized clinical excellence delivered directly to your home or virtually across Canada&apos;s major metropolitan regions.
          </p>
        </div>
        ...
        <div className="text-center pt-4">
          <Link
            ...
            prefetch={false}
          >
            <span>Explore All 10 Canadian Provinces &amp; Coverage Zones</span>
