...
const recoveryStages = [
  {
    ...
    description: 'Proprietary computer vision algorithms analyze joint angles and kinematics to identify the exact mechanical source of pain.',
    icon: ShieldCheck,
    color: 'text-primary',
  ...
  },
  {
    ...
    description: 'Evidence-based protocols tailored to your pathology, range of motion goals, and Canadian lifestyle activities.',
    icon: Target,
    color: 'text-accent',
  ...
  },
  {
    ...
    description: 'Continuous monitoring of range of motion milestones (0° extension in TKR, 120° shoulder abduction) at every visit.',
    icon: Activity,
    color: 'text-primary',
    bgColor: 'bg-primary/10',
  },
  {
    ...
    description: 'Intelligent progressive loading and neuromuscular retraining to restore strength and prevent reinjury.',
    icon: ArrowUpCircle,
    color: 'text-accent',
    bgColor: 'bg-accent/10',
  },
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 space-y-16">
        <div className="max-w-4xl mx-auto text-center space-y-6 flex flex-col items-center animate-reveal-up">
          <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-primary/10 border border-primary/20 text-primary text-xs font-bold uppercase tracking-[0.2em] shadow-sm">
            <Microscope className="w-4 h-4" /> Aries AI™ Directorate Canada
          </div>
              ...
              <div className="flex-1 space-y-8 text-center lg:text-left">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-accent/10 border border-accent/20 text-accent text-xs font-bold uppercase tracking-[0.2em] shadow-sm">
                  <span className="flex items-center gap-2">
                    <Sparkles className="w-4 h-4" /> Interactive 3D Anatomy &amp; Biomechanics
                  </span>
                </div>
                <div className="space-y-4">
                  ...
                  <p className="text-lg text-muted-foreground leading-relaxed max-w-xl mx-auto lg:mx-0 font-light">
                    Go beyond general symptom tracking. Our 3D Anatomy &amp; Kinematics Lab creates an interactive visualization of your joints, muscles, and surgical pathways across Canada.
                  </p>
                </div>
