...
import { Activity, ChevronRight, Sparkles, Compass } from "lucide-react";
...
const treatCategories = [
  {
    title: "Conditions",
    items: [
      "Sciatica & Disc Herniation", "ACL & Meniscus Tears", "Rotator Cuff Tendinopathy",
      "Knee Osteoarthritis", "Neck Pain & Whiplash", "Carpal Tunnel Syndrome",
      "Frozen Shoulder", "Plantar Fasciitis", "Tennis Elbow", "Post-Stroke Recovery",
      "Parkinson's Mobility", "Post-Op Knee Replacement", "Post-Op Hip Replacement", "Ankle Sprains"
    ]
  },
  {
    title: "Symptoms",
    items: [
      "Radiating Nerve Pain", "Joint Stiffness", "Loss of Balance & Falls",
      "Muscle Spasms", "Numbness & Tingling", "Limited Range of Motion",
      "Post-Surgical Weakness", "Headaches & Concussion", "Joint Clicking & Crepitus"
    ]
  },
  {
    title: "Therapies Offered",
    items: [
      "Orthopedic Manual Therapy", "Dry Needling / IMS", "Kinematic Movement Retraining",
      "Joint Mobilization", "Supervised Resistance Loading", "Bobath Neurological Rehab",
      "Pelvic Floor Therapy", "Myofascial Trigger Point Release", "Post-Surgical 0-120° ROM Protocol"
    ]
  },
  {
    title: "Clinical Formats",
    items: [
      "In-Home Mobile Physiotherapy", "Virtual Tele-Physiotherapy", "MVA Auto Claims (OCF-18 / ICBC)",
      "Workplace WSIB & WorkSafe", "Post-Hospital Discharge Care", "Seniors Home Safety Audit"
    ]
  }
];
