          ...
          <div className="grid md:grid-cols-2 gap-0 items-stretch bg-gradient-to-br from-background to-primary/5 dark:from-card dark:to-primary/10">
            <div className="p-10 md:p-16 space-y-6 flex flex-col justify-center">
              ...
              <p className="text-muted-foreground text-lg md:text-xl leading-relaxed font-light">
                Connect directly with a Canadian Registered Physiotherapist (CPO / CPTBC). Review your symptoms, get your direct billing questions answered, and plan your in-home or virtual care.
              </p>
              
              <div className="space-y-2 text-xs text-muted-foreground">
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-emerald-500 shrink-0" />
                  <span>Direct consultation with licensed Canadian physiotherapists</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-primary shrink-0" />
                  <span>Instant insurance direct billing check (Sun Life, Manulife, Canada Life)</span>
                </div>
              </div>
            ...
            <div className="relative hidden md:block min-h-[450px]">
              <Image
                ...
                alt="Canadian Telehealth consultation"
                fill
