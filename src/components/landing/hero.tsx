        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-12">
          <div className="max-w-4xl text-left">
            ...
            <div className="flex flex-wrap gap-3 mb-8 animate-in fade-in slide-in-from-left-8 duration-700 delay-100 fill-mode-both">
              ...
              <div className="glassmorphic py-1.5 px-4 rounded-full border border-white/20 flex items-center gap-2">
                ...
                <span className="text-[10px] md:text-xs font-bold uppercase tracking-wider text-primary-foreground">
                  Direct Billing (Sun Life, Manulife &amp; 25+)
                </span>
              </div>
            </div>
            ...
            <p className="mt-8 text-lg sm:text-xl md:text-2xl text-white/80 font-medium max-w-2xl leading-relaxed animate-in slide-in-from-left-8 duration-1000 delay-400 fill-mode-both drop-shadow">
              Request in-home registered physiotherapy and specialized tele-rehabilitation from the Aries clinical network across Toronto, Vancouver, Calgary, Ottawa &amp; Montreal.
            </p>
            ...
            <div className="mt-16 pt-8 border-t border-white/10 flex flex-wrap gap-8 md:gap-16 animate-in fade-in duration-1000 delay-800 fill-mode-both">
              <div>
                <p className="text-3xl md:text-4xl font-black text-white">45+</p>
                <p className="text-[10px] md:text-xs font-bold uppercase tracking-widest text-white/50">CPO / CPTBC PTs</p>
              </div>
              <div>
                <p className="text-3xl md:text-4xl font-black text-white">12,500+</p>
                <p className="text-[10px] md:text-xs font-bold uppercase tracking-widest text-white/50">Canadian Patients</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-[10px] md:text-xs font-bold uppercase tracking-widest text-white/50">Direct Access (No Referral)</p>
              </div>
            </div>
          </div>
        </div>
