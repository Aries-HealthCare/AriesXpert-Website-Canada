...
const CANADIAN_POSTS = [
  {
    id: "p1",
    slug: "canadian-winter-slip-fall-prevention",
    title: "Canadian Winter Slip-and-Fall Prevention: Core & Vestibular Protocols",
    summary: "Ice and snow dramatically increase fracture and ligament tear risks. Discover clinical balance strategies, proprioceptive training, and fall-safe recovery mechanics.",
    serviceTag: "Preventative Health",
    readTime: "5 min read",
    author: "Elena Vance, PT (FCAMPT)",
    date: "Aug 2026",
  ...
  },
  {
    ...
    summary: "A complete patient guide to starting your motor vehicle accident physiotherapy claim, understanding direct insurer billing, and recovering from cervical trauma.",
    serviceTag: "MVA & Auto Claims",
    readTime: "7 min read",
    author: "Marcus Thorne, PT (CSCS)",
    date: "Aug 2026",
  ...
  },
  {
    ...
    summary: "From day 1 passive extension to week 12 independent stair descent. What Canadian patients need to know about post-surgical in-home physiotherapy.",
    serviceTag: "Post-Surgical Care",
    readTime: "6 min read",
    author: "Sophie Tremblay, PT (CIDN)",
    date: "Jul 2026",
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 space-y-12">
        <div className="max-w-4xl mx-auto text-center space-y-6 flex flex-col items-center animate-reveal-up">
          <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-primary/10 border border-primary/20 text-primary text-xs font-bold uppercase tracking-[0.2em] shadow-sm">
            <BookOpen className="w-4 h-4" /> Canadian Health Directorate
          </div>
          ...
          <p className="text-base md:text-lg text-muted-foreground leading-relaxed max-w-3xl mx-auto font-light">
            Written by licensed Canadian Registered Physiotherapists. Grounded in peer-reviewed clinical research and Canadian healthcare guidelines.
          </p>
        </div>

        {/* 3 Articles Grid */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {CANADIAN_POSTS.map((post) => (
        ...
        <div className="text-center pt-4">
          <Link
            ...
            prefetch={false}
          >
            <span>Explore Complete Movement Library</span>
