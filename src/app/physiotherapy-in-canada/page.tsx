...
export const metadata: Metadata = {
  title: 'Best In-Home Physiotherapy Services in Canada | Aries PhysioCare Canada',
  description:
    'Aries PhysioCare provides hospital-grade in-home and virtual physiotherapy across Toronto, Vancouver, Calgary, Ottawa, Montreal & Edmonton. Registered with CPO, CPTBC, Physiotherapy Alberta & OPPQ. Direct billing to Sun Life, Manulife, Canada Life.',
  keywords: [
    'physiotherapy in canada',
    'in-home physiotherapy canada',
    'best physiotherapist canada',
    'registered physiotherapist canada',
    'aries physiocare canada',
  ...
  alternates: {
    canonical: 'https://ca.ariesphysiocare.com/physiotherapy-in-canada',
  },
};

const NATIONAL_STATS = [
  { label: 'Licensed Clinicians', value: '150+' },
  { label: 'Provinces & Metros', value: '10+' },
  { label: 'Patient Satisfaction', value: '98.5%' },
  { label: 'Direct Billing Partners', value: '20+' },
];

const PROVINCIAL_REGULATORY_BODIES = [
  { province: 'Ontario', body: 'College of Physiotherapists of Ontario (CPO)', hub: 'Toronto & GTA, Ottawa, Mississauga, Brampton, Hamilton' },
  { province: 'British Columbia', body: 'College of Physical Therapists of BC (CPTBC)', hub: 'Vancouver, Richmond, Burnaby, Victoria, Surrey' },
  { province: 'Alberta', body: 'Physiotherapy Alberta College + Association', hub: 'Calgary, Edmonton, Red Deer, Lethbridge' },
  { province: 'Quebec', body: 'Ordre professionnel de la physiothérapie du Québec (OPPQ)', hub: 'Montreal, Quebec City, Laval, Gatineau' },
];

export default function PhysiotherapyInCanadaPage() {
  return (
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/20 text-white text-xs font-bold uppercase tracking-widest">
              <Shield className="w-3.5 h-3.5 text-accent" /> Nationwide Canadian Clinical Network
            </div>
            <h1 className="font-headline text-4xl sm:text-5xl md:text-6xl font-extrabold text-white tracking-tight leading-tight">
              Registered In-Home <br className="hidden sm:inline" />
              <span className="text-accent">Physiotherapy Across Canada</span>
            </h1>
            <p className="text-white/85 text-lg md:text-xl leading-relaxed max-w-3xl mx-auto font-light">
              Hospital-grade clinical physical therapy delivered directly to your doorstep or virtually. Certified with Canadian provincial colleges with instant direct billing to all major extended health insurers.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
              ...
              <Button
                ...
                asChild
              >
                <Link href="#cities">Explore Canadian Hubs</Link>
              </Button>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 md:px-6 space-y-12">
          <div className="max-w-3xl mx-auto text-center space-y-4">
            ...
            <p className="text-muted-foreground text-base md:text-lg">
              Select your Canadian city to view local clinical teams, same-day visit availability, and direct billing options.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 md:px-6 space-y-12">
          <div className="max-w-3xl mx-auto text-center space-y-4">
            <h2 className="font-headline text-3xl md:text-4xl font-extrabold text-foreground">
              Provincially Regulated &amp; Fully Certified
            </h2>
            <p className="text-muted-foreground text-base">
              Every practitioner in the Aries PhysioCare network is licensed with their respective provincial regulatory body.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {PROVINCIAL_REGULATORY_BODIES.map((reg, idx) => (
              <div key={idx} className="p-6 rounded-2xl bg-card border border-border/50 space-y-2">
                ...
                <p className="text-xs text-muted-foreground">Coverage zones: {reg.hub}</p>
              </div>
            ))}
          </div>
        </div>
